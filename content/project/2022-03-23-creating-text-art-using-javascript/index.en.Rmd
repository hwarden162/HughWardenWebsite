...
I love finding cool ways to visualise my work, especially as I am often working with people who have a completely different background to me and I need to communicate what I have done. In doing this I spend a lot of time researching visualisation and I came across a cool video from [The Coding Train](https://www.youtube.com/channel/UCvjgXvBlbQiydffZU7m1_aw) on creating [ASCII Videos](https://www.youtube.com/watch?v=55iwMYv8tGI&t=745s). It's super cool but never going to come up in my work. But when I decided I wanted a cool graphic for the beginning of a presentation I decided to give it a try.

The idea behind the video is that different ASCII characters take up different amount of space, for example and 'N' lights up more pixels than a hyphen '-'. This can then be used as a primitive form of shading, in that every picture of a grayscale image can be replaced with a square and at the center of the square a character could be written. If a pixel is bright than a character should be drawn that will light up more pixels. This effect actually works rather well.

The presentation I am doing is on using machine learning to investigate how cells change shape when we mutate the TP53 gene. This means I have loads of cool pictures of cells that look really impressive (just google [cell painting](https://www.google.com/search?q=cell+painting+fluorescence&tbm=isch&ved=2ahUKEwjyysWvg9v2AhVF44UKHbl5AuEQ2-cCegQIABAA&oq=cell+painting+fluorescence&gs_lcp=CgNpbWcQAzoHCCMQ7wMQJzoFCAAQgAQ6BggAEAUQHjoECAAQHjoGCAAQCBAeUKA6WLyDAWD0hwFoC3AAeACAAV6IAeILkgECMjSYAQCgAQGqAQtnd3Mtd2l6LWltZ8ABAQ&sclient=img&ei=bHA6YvLkFcXGlwS584mIDg&bih=787&biw=1440&client=firefox-b-d) for some examples) but I also wanted to add a nod to machine learning, the main focus of my work. I decided the character overlay gave the picture a more computational theme.
